...
function bindAllBacnetValues(organModel: SpinalOrganConfigModel) {
...
function bindListenerModels(organModel: SpinalOrganConfigModel, listenerAlreadyBinded: Set<number>) {
...
function bindPilotModels(organModel: SpinalOrganConfigModel) {
...
function bindDiscoverModel(organModel: SpinalOrganConfigModel, discoverAlreadyBinded: Set<number>) {
