...
class BacnetUtilitiesClass {
    ...
    initAndConnect() {
        const serverServiceName = "spinal_bacnet_service";
        const clientServiceName = "spinal_bacnet_client";
        ipc.config.id = clientServiceName;
        ipc.config.retry = 1500;
        ipc.connectTo(serverServiceName, () => {
            ipc.of[serverServiceName].on('connect', () => {
                console.log("connected to server");
            });
            ipc.of[serverServiceName].on('disconnect', () => {
